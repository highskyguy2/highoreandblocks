...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, RUBY_ORE_KEY, Feature.ORE, new OreFeatureConfig(overworldPinkGarnetOres, 12));

    }

    public static RegistryKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(HighsOresAndBlocks.MOD_ID, name));
    }
